describe('rudhir website', function(){
    ...
    it('rudhir patient registration', function(){
        ...
        patientCellNumber.sendKeys('9890090200');
        browser.sleep(1000);
        ...
        relativeCellNumber.sendKeys('9890090000');
        browser.sleep(1000);
        ...
        hcellnumber.clear();
        hcellnumber.sendKeys('2893222323');
        browser.sleep(1000);
